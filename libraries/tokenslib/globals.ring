...
if number(version()) >= 1.25
	aKEYWORDS = [
		...
		"THIS","SELF","SUPER",
		"MAIN","INIT","OPERATOR",
		"BRACESTART","BRACEEXPREVAL","BRACEERROR","BRACENEWLINE","BRACEEND",
		"RINGVM_SEE","RINGVM_GIVE","RINGVM_ERRORHANDLER",
...
if number(version()) >= 1.25
	...
	K_RINGVMSEE             = 68
	K_RINGVMGIVE            = 69
        K_RINGVMERRORHANDLER    = 70
	K_CHANGERINGKEYWORD     = 71
	K_CHANGERINGOPERATOR    = 72
	K_LOADSYNTAX            = 73
	K_ENABLEHASHCOMMENTS    = 74
	K_DISABLEHASHCOMMENTS   = 75
else
	K_CHANGERINGKEYWORD     = 57
	K_CHANGERINGOPERATOR    = 58
	K_LOADSYNTAX            = 59
	K_ENABLEHASHCOMMENTS    = 60
	K_DISABLEHASHCOMMENTS   = 61
ok
