...
RING_API Item *ring_item_new(unsigned int nItemType) { return ring_item_new_gc(NULL, nItemType); }

RING_API Item *ring_item_delete(Item *pItem) { return ring_item_delete_gc(NULL, pItem); }
...
RING_API void ring_item_setstring(Item *pItem, const char *cStr) { ring_item_setstring_gc(NULL, pItem, cStr); }

RING_API void ring_item_setdouble(Item *pItem, double x) { ring_item_setdouble_gc(NULL, pItem, x); }

RING_API void ring_item_setpointer(Item *pItem, void *pValue) { ring_item_setpointer_gc(NULL, pItem, pValue); }
